...
use PDO;
use PDOException;
use Ejercicios\act31\model\vo\MunicipioVO;
...
class MunicipioModel extends Model
{
     ...
     */
    public static function getMunicipio(int $id): ?MunicipioVO
    {
    ...
    public static function add(MunicipioVO $vo): MunicipioVO|false
    {
        ...
        return $id ? self::getMunicipio($id) : false;
    }
    ...
    public static function update(MunicipioVO $vo): MunicipioVO|false
    {
        ...
        return $result ? self::getMunicipio($vo->getCodMunicipio()) : false;
    }
